...
using UmbracoForms.MailChimp.Workflow.UmbracoBuilderExtensions;

namespace UmbracoForm.MailChimp.WorkFlow.Composers
{
    public class UmbracoFormMailChimpWorkFlowApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Umbraco Form Mail Chimp Work Flow Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<UmbracoFormMailChimpWorkFlowOperationSecurityFilter>();
            });
        }

        public class UmbracoFormMailChimpWorkFlowOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("UmbracoForm.MailChimp.WorkFlow.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
